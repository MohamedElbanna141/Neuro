...
Route::get('getNearDoctors/{ip}', [LocController::class,'getNearDoctors']);
Route::get('getNearHospitals/{ip}', [LocController::class,'getNearHospitals']);
Route::get('getNearPharmacies/{ip}', [LocController::class,'getNearPharmacies']);
Route::get('getNearLabs/{ip}', [LocController::class,'getNearLabs']);


Route::post('register_one', [AuthController::class,'register_one']);
Route::post('login_one', [AuthController::class,'login_one']);
Route::post('logout_one', [AuthController::class,'logout_one']);

////////////////////Login With Google///////////////////////////////
Route::group(['middleware' => ['web']], function () {
    Route::get('auth_redirect', [SocialAuthController::class,'auth_redirect']);
    Route::get('auth_callback', [SocialAuthController::class,'auth_callback']);
});

//////////////////////////////User Profile///////////////////////////
Route::put('UpdateUserData',[UserController::class,'UpdateUserData']);
Route::get('SelectUser/{user_id}',[UserController::class,'SelectUser']);
...
Route::post('AddOffer',[PharmacyController::class, 'AddOffer']);
Route::post('DeleteOffer',[PharmacyController::class,'DeleteOffer']);
Route::get('SelectAllOffers',[PharmacyController::class,'SelectAllOffers']);
...
Route::get('SelectAllAlerts',[AlertController::class,'SelectAllAlerts']);
